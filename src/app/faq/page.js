...
const faqs = {
    ...
    Volunteer: [
        ...
        {
            question: "What exactly do volunteers do?",
            answer: "We attend services for nurses that pass away and provide a tribute to them for their family and friends. Also we do fundraising activities and attend other community events.",
        },
        {
            question:
                "I have mobility issues so am not sure if I can attend services. Can I still be a volunteer?",
            answer: "Yes please! We welcome you to participate as we always need support to make phone calls, coordinate services and there is a lot we do over the phone, online and virtually.",
        },
    ],
};
