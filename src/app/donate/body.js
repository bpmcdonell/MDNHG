    ...
    return (
        <div>
            ...
            <p className="my-2 text-base">
                ...
                purchases to provide free tributes to families of nurses. If we
                have any residual funds after our expenses we hope to develop a
            ...
            <p className="my-2 text-base">
                ...
                candle for your nurse on our gratitude wall. Please be certain
                to provide the full name of the nurse you would like to honor
                with your donation information, and the family contact
                information if you would like us to notify the family of your
                donation in their nurse&#39;s honor as well.
            </p>
